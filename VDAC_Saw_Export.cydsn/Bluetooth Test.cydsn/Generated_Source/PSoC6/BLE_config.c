...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x5Fu, 0x50u, 0x53u, 0x4Fu, 0x43u, 0x11u, 0x07u,
        0x52u, 0x32u, 0x9Bu, 0x20u, 0xB8u, 0x46u, 0x63u,
        0x92u, 0x93u, 0x4Eu, 0xCDu, 0x3Eu, 0x8Au, 0x40u,
        0xE8u, 0xC6u, 0x00u }, /* uint8_t advertising_data[CY_BLE_MAX_ADV_DATA_LEN] */ 
...
static uint8_t cy_ble_attValues[0x19u] = {
    /* Device Name */
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Device Interface */
    { 0x52u, 0x32u, 0x9Bu, 0x20u, 0xB8u, 0x46u, 0x63u, 0x92u, 0x93u, 0x4Eu, 0xCDu, 0x3Eu, 0x8Au, 0x40u, 0xE8u, 0xC6u },
    /* current_val */
    { 0xF3u, 0xC1u, 0x22u, 0xB3u, 0xF4u, 0x55u, 0x07u, 0x86u, 0x8Au, 0x49u, 0xF3u, 0xFAu, 0xC0u, 0x2Cu, 0x2Cu, 0xA2u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Au] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* current_val UUID */
    { 0x0002u, (void *)&cy_ble_attValues[23] }, /* current_val */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x12u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x08000001u /*       */, 0x0012u, {{0x0010u, (void *)&cy_ble_attValuesLen[7]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0012u, {{0x0010u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0012u, 0x2CC0u /* current_val                         */, 0x09020001u /* rd    */, 0x0012u, {{0x0002u, (void *)&cy_ble_attValuesLen[9]}} },
};
