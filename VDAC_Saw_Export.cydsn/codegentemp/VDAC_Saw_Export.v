...
module VDAC12_PDL_v2_0_1 (
    ...
    cy_mxs40_samplehold_v1_0 SAMPLEHOLD (
        .vin(ct_vout));
    ...
    bIncludeDriverToComponent_v1_0_0 IncludeDriver_1 ();
...
module Scan_ADC_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("9d493f65-e233-4233-b1ee-7728171ac021/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE_1:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=BLE_1_IncludeBleLibs, )
...
module top ;
	...
	cy_gsref_v1_0
		#(.guid("67373773-A8EC-4E91-9CBE-FA0D4C5BD8C3"))
		GlobalSignal_1
		 (.sig_out(Net_61));
	...
	cy_mxs40_gpio_v1_0
		#(.id("52b39e98-8c09-4d72-bee9-530c70baa6ff"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
