...
module top ;
	...
	wire [0:0] tmpFB_0__SquareWave_net;
	wire [0:0] tmpIO_0__SquareWave_net;
	electrical [0:0] tmpSIOVREF__SquareWave_net;
	...
	cy_mxs40_gpio_v1_0
		...
		SquareWave
		 (.oe({1'b1}),
		  .y({Net_21}),
		  .fb({tmpFB_0__SquareWave_net[0:0]}),
		  .io({tmpIO_0__SquareWave_net[0:0]}),
		  .siovref(tmpSIOVREF__SquareWave_net));
